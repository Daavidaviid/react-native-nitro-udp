...
namespace margelo::nitro::udp {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/udp/Func_void_std__shared_ptr_ArrayBuffer_;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/udp/Func_void_std__shared_ptr_ArrayBuffer__cxx;";
