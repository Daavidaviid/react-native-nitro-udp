...
namespace margelo::nitro::udp {
  ...
  /**
   * Represents the Java/Kotlin callback `(data: String) -> Unit`.
  ...
  public:
     ...
     */
    void invoke(const std::string& data) const {
      static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* data */)>("invoke");
      method(self(), jni::make_jstring(data));
    }
  };
  ...
  public:
     ...
     */
    void invoke_cxx(jni::alias_ref<jni::JString> data) {
      _func(data->toStdString());
    }

  public:
    [[nodiscard]]
    inline const std::function<void(const std::string& /* data */)>& getFunction() const {
      return _func;
    }
  ...
  private:
    explicit JFunc_void_std__string_cxx(const std::function<void(const std::string& /* data */)>& func): _func(func) { }
